...
export function Sidebar() {
  return (
    <aside className="relative z-10 flex w-20 flex-shrink-0 flex-col overflow-hidden md:w-60">
      <div className="glass-panel-strong flex h-full flex-col p-3 pt-10">
        ...
        <div className="hidden rounded-xl border border-white/10 bg-slate-900/45 px-3 py-2 text-xs text-[var(--text-faint)] md:block">
          v1.0.0
        </div>
      </div>
    </aside>
